...
const char* mqtt_server = "192.168.0.109"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    Serial.print("Temperatura en °C: "); // Se imprime en monitor solo para poder visualizar que el evento sucede
    Serial.println(dataString);
    client.publish("CodigoIoT/temp", dataString); // Esta es la función que envía los datos por MQTT, especifica el tema y el valor
    ...
    Serial.print("Humedad en %: "); // Se imprime en monitor solo para poder visualizar que el evento sucede
    Serial.println(dataString_2);
    client.publish("CodigoIoT/hume", dataString_2); // Esta es la función que envía los datos por MQTT, especifica el tema y el valor
